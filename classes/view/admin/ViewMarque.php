...
?>
  ...
  public static function voirMarque($id)
  {
    ...
    $listeProdParMarque = $modelProduit->produitParMarque($id);
  ?>
    <div class="container">
      <div class="row mb-4">
        <div class="col-md-12">
          ...
          <div class="card">
            ...
            <ul class="list-group list-group-flush border-0 mb-2">
              <li class="list-group-item">
                ...
                <a href="modif.php?id=<?= $marque['id'] ?>" class="btn btn-warning"><i class="fas fa-edit"></i>&nbsp; Modifier</a>
                <a href="supp.php?id=<?= $marque['id'] ?>" <?= (count($listeProdParMarque) > 0) ? "class='btn btn-danger btn-cache'" : "class='btn btn-danger'" ?>><i class="fas fa-trash-alt"></i>&nbsp; Supprimer</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-12">
          ...
          if (count($listeProdParMarque) > 0) { ?>
            <table class="table table-striped">
              ...
              <tbody>
                <?php
                foreach ($listeProdParMarque as $produit) {
                ?>
                  <tr>
          ...
          ?>
            <div class="alert alert-danger" role="alert">
              <i class="fas fa-times"></i>&nbsp; Aucun produit n'appartient à la marque "<?= $marque['nom'] ?>".
            </div>
          <?php
          }
          ?>
