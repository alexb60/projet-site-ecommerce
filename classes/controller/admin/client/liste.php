...
ViewTemplate::headHtml("Liste des clients");
...
if (isset($_SESSION['id_employe'])) {
  ...
  if ($_SESSION['perm']['Clients'] == "oui") {
    ...
    $pages = ceil($nbClients / $parPage); // CALCUL DU NOMBRE DE PAGE NÉCESSAIRE ARRONDI À L'ENTIER SUPÉRIEUR (fonction ceil)
    $premier = ($pageActuelle * $parPage) - $parPage; // CALCUL DU 1ER CLIENT DE LA PAGE
